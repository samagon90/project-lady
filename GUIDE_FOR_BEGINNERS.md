...
| Окно показывает бессмысленные буквы и ошибки вроде `'cho.' is not recognized` | Скачана старая версия файла запуска (ошибка кодировки) | Скачайте новую версию: та же ссылка с GitHub (v0.1.1), распакуйте заново и запустите `start_windows.bat` |
