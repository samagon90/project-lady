...
- Если в запросе указан «ЭКСТРЕМАЛЬНЫЙ NSFW» — добавь также теги: hardcore,
  detailed genitals, explicit sex (только для взрослого вымышленного
  персонажа 21+, только при явном эротическом запросе);
