...
## 📱 APK-приложение «Лилит: Новелла» (Android, офлайн)

Новелла доступна как **отдельное приложение для Android** — без бота и без интернета:

- 📥 Скачать: `novel_app/LilithNovel.apk` в этом репозитории
  (прямая ссылка: https://github.com/samagon90/project-lady/raw/arena/019fff94-project-lady/novel_app/LilithNovel.apk)
- ✅ Работает **полностью автономно** (без сети, без сервера, без бота):
  все 6 сценариев и 46 фото упакованы внутрь приложения
- 🔞 Возрастной гейт 18+ при первом запуске
- 💾 Сохранение прогресса (продолжить с места остановки)
- Установка: скачайте APK → откройте файл → разрешите «установку из
  неизвестных источников» → играйте
- Сборка: `python3 scripts/build_apk_manual.py` (не требует Android SDK:
  smali + свой генератор манифеста + подпись v1)

## 🚀 v2.8.0 — что нового

- **🎮 Новелла стала сборником из 6 сценариев** — все наши серии фото в игре:
  1. 🍸 «Рандеву с похотливой незнакомкой» (бар)
  2. 👩🏫 «Строгая учительница. После уроков» (форма, доминирование)
  3. 👠 «Доминанта. Её кабинет» (юбка-карандаш, ракурс снизу)
  4. 🧪 «Алхимик 2042» (лаборатория зелий)
  5. 🔥 «Горячее аниме. Её мир» (аниме-стиль)
  6. 🔥 «Развратная ночь» (самая откровенная)
- В Mini App — меню выбора истории, у каждой — свои фото-сцены, 2-3
  концовки, кнопки «🔄 Сыграть ещё раз» / «📚 Все сценарии».
- API: /api/novel (список), /api/novel/{id} (сценарий).

## 🚀 v2.7.7 — что нового

- **🔥 Серия «Горячее аниме»** — 7 откровенных аниме-фото (ещё 3 следующим
  шагом): Лилит в аниме-стилистике (cel shading) — в тёмном белье и чулках,
  возбуждённая, соблазнительные позы (на кровати, тянет чулок, у стены,
  на коленях, у зеркала, наклон над столом). Отдельная секция
  «🔥 Горячее аниме» в галерее Mini App.

## 🚀 v2.7.6 — что нового

- **👩🏫 Ещё 9 фото «Строгой учительницы»** (теперь 19 всего): руки
  скрещены у доски, указка в камеру, наклон над столом, красная ручка
  над тетрадью, шёпот у парты, пишет мелом на доске, у двери
  («на задержание»), указка у подбородка, руки на столе. Все в форме,
  доминируют. (20-е — следующим шагом, лимит генератора.)

## 🚀 v2.7.5 — что нового

- **👩🏫 Серия «Строгая учительница» переснята в ФОРМЕ и доминирующей**:
  Лилит в учительской форме (белая блузка, тёмная юбка-карандаш, чулки,
  высокие каблуки, очки, указка) — строгий взгляд сверху вниз, командует,
  «останься после уроков». Все 10 фото (01..10) в форме; 3 недостающих
  догенерированы. Правило закреплено в persona, character_sheet,
  AI_DEVELOPER: учительница/доминанта — ВСЕГДА в форме и доминирует.

## 🚀 v2.7.4 — что нового

- **🔥 Серия «Развратная»** — 7 самых откровенных фотореалистичных фото:
  наклон над столом с прогибом, на коленях с выгнутой спиной, рука
  тянет чулок, расстёгнутый бюстгальтер, лёжа на боку с поднятой ногой,
  на коленях на полу, у зеркала. Всё в тёмном белье, чулках, возбуждённая,
  пальчик у губ. Первая секция «🔥 Развратная» в галерее Mini App.
  (Ещё 3 фото следующим шагом — лимит генератора.)

## 🚀 v2.7.3 — что нового

- **👠 Серия «Доминанта»** — 10 фотореалистичных фото: Лилит в белой
  рубашке, чёрной юбке-карандаше, чулках и очень высоких каблуках,
  с указкой, строгим взглядом и РАКУРСОМ СНИЗУ ВВЕРХ — она смотрит на
  тебя сверху вниз, каблуки на переднем плане. Офис, коридор, лестница,
  доска, окно с городом. Отдельная секция «👠 Доминанта» в галерее Mini App.

## 🚀 v2.7.2 — что нового

- **👩🏫 Серия «Строгая учительница»** — 7 фотореалистичных фото (ещё 3
  следующим шагом): Лилит в роли строгой учительницы после уроков —
  очки, указка, классная доска, карта, книги; в тёмном белье и чулках,
  возбуждённая, пальчик у губ. Отдельная секция «👩🏫 Строгая учительница»
  в галерее Mini App.

## 🚀 v2.7.1 — что нового

- **🧪 Серия «Лилит-Алхимик, 2042»** — 10 новых фотореалистичных фото:
  Лилит в роли ведьмы-зельевара в ночной лаборатории (колбы со светящимися
  зельями, котёл, реторта, гримуары, свечи). В тёмном белье, чулках,
  возбуждённая, пальчик у губ. Отдельная секция «🧪 Алхимик 2042»
  в галерее Mini App.
- **📜 Гримуар Архивариуса** — пасхалка в разделе «Ещё»: «Перегонный лист
  №447-А» — инструкция Архивариуса 2042 на языке зельеварения (запуск
  кластера, healthcheck, репликация, ротация секретов).

## 🚀 v2.7.0 — что нового

- **🎮 Визуальная новелла «Рандеву с похотливой незнакомкой» (18+)** —
  прямо в Mini App (вкладка «Новелла»): фото + текст + выбор диалогов.
  Ветвящаяся история: 12 узлов, 4 концовки («страстная ночь», «нежность»,
  «дразнилка», «скромник»). Лилит в роли незнакомки в баре: рыжие хвостики,
  тёмное бельё, чулки, пальчик у губ. Каждый выбор меняет историю;
  можно переигрывать. Сценарий — в `src/novel.py`, 8 новых фото сцен
  (`assets/gallery/lilith_novel_01..08`).

## 🚀 v2.6.2 — что нового

- **🖤 Тёмное бельё и фирменный жест Лилит** (правила пользователя):
  - Лилит любит ТОЛЬКО тёмное бельё — чёрное, тёмно-красное (вишнёвое),
    тёмно-фиолетовое, тёмно-синее, тёмно-изумрудное. Светлого больше нет.
  - Рот ВСЕГДА слегка приоткрыт (чувственно), и она часто держит пальчик
    у губ — её жест-подпись.
- Все 10 toon-эмоций перегенерированы с этими правилами (passion, flirt,
  playful, happy, shy, neutral, tender, excited, sad, surprised).
- Правила закреплены в persona_lilith.md, character_sheet.md и
  AI_DEVELOPER.md.

## 🚀 v2.6.1 — что нового

- **🎬 Мультяшный стиль стал ДИСНЕЕВСКИМ и ещё сексуальнее**: большие
  выразительные глаза, длинные ресницы, глянцевые губы, гладкая анимация;
  фигура как у Джессики Рэббит с ОЧЕНЬ длинными ногами; Лилит всегда
  возбуждена (томный взгляд, румянец). 9 эмоций в белье и чулках
  (passion, flirt, playful, happy, shy, neutral, tender, excited, sad) —
  остальные подставляются ближайшими.

## 🚀 v2.6.0 — что нового

- **🎬 Новый мультяшный стиль «toon»** (как Джессика Рэббит): классическая
  рисованная красотка 40-х — пышные формы, длинные ноги, гламурный вид,
  чувственный взгляд. Третий стиль Лилит: 📸 реалистичный / 🖌 аниме /
  🎬 мультяшный.
- 6 мультяшных эмоций в белье и чулках (passion, flirt, playful, happy,
  shy, neutral) — остальные 17 подставляются ближайшими.
- Переключение: `/style` в Telegram (кнопка «Мультяшный») или настройки
  Mini App (🎬 Мультяшный).
- Образы для галереи в этом стиле — следующим шагом (лимит генератора).

## 🚀 v2.5.0 — что нового

- **🔥 Лилит ВСЕГДА ВОЗБУЖДЕНА** (правило пользователя): её естественное
  состояние — желание и страсть. Эмоция по умолчанию — passion: томный
  голодный взгляд, приоткрытые губы, румянец, выгнутая спина.
- В чате и Mini App нейтральных состояний больше нет — если эмоция не
  определилась, Лилит страстная (passion).
- **6 новых возбуждённых фотореалистичных фото** (в белье и чулках):
  чёрное кружево на кровати, красный комплект у кровати, белое кружево
  на краю кровати, лавандовый комплект у окна, чёрный корсет у зеркала,
  изумрудное кружево в кресле. (Ещё 4 — следующим шагом, лимит генератора.)
- Правило закреплено в persona_lilith.md, character_sheet.md и
  AI_DEVELOPER.md: «всегда возбуждена, эмоция по умолчанию — passion».

## 🚀 v2.4.0 — что нового

- **🩲 Лилит ТОЛЬКО В НИЖНЕМ БЕЛЬЕ** (правило пользователя): все 20
  реалистичных фото перегенерированы в белье (кружево, шёлк, корсеты,
  бабидолы — всегда с чулками на подвязках). Одежда осталась только на
  художественных образах по явной просьбе.
- **Настройка «Лилит всегда в белье»** (включена по умолчанию): аватары
  и эмоции в чате и Mini App — бельевые. Можно выключить в настройках.
- Правило закреплено в persona_lilith.md, character_sheet.md и
  AI_DEVELOPER.md: «только в белье + чулки никогда не снимаются».

## 🚀 v2.3.1 — что нового

- **🩲 Лилит НИКОГДА не снимает чулки** (правило пользователя, закреплено
  в persona, character_sheet, AI_DEVELOPER и батч-скрипте): чулки с
  подвязками присутствуют на ЛЮБОМ её изображении — одетая, в белье,
  дома, ночью, после душа. Все фото галереи перегенерированы с чулками,
  добавлено 10-е фото в белье (`lilith_real_20`).

## 🚀 v2.3 — что нового

- **🩲 Реалистичные фото Лилит в нижнем белье** — 10 фотореалистичных снимков
  в том же стиле «как реальная девушка»: чёрное кружево на кровати, белый
  комплект у зеркала, красный шёлковый пеньюар, пояс с подвязками у окна,
  розовый бабидол, чёрный корсет, лавандовый комплект на кровати, белый
  халат после душа, изумрудное кружево на стуле, белое кружево с чулками.
  Все — в секции «📸 Реальные фото» галереи Mini App (кнопка «👗 Надеть»
  работает).

## 🚀 v2.2 — что нового

- **📸 Реалистичные фото Лилит в одежде** — 10 фотореалистичных снимков,
  как будто реальная девушка: красное платье на вечерней улице, джинсы в кафе,
  чёрное коктейльное платье, осеннее пальто, летнее платье в парке, уютный
  свитер дома, кожаная куртка в городе, белая блузка с плиссированной юбкой,
  спортивный образ на набережной, синее атласное платье на террасе.
  Отдельная секция «📸 Реальные фото» в галерее Mini App (кнопка «👗 Надеть»
  тоже работает).

## 🚀 v2.1 — что нового

- **🎂 День рождения**: Лилит помнит дату (настройки Mini App, формат ММ-ДД)
  и в день рождения ОБЯЗАТЕЛЬНО поздравляет — тепло, нежно и игриво.
- **🌅 Осознание времени суток** (как Paradot): утром Лилит сонная и нежная,
  вечером — свечи и флирт, ночью — шёпот и желания. Промпт меняется сам.
- **🎁 Ежедневная награда**: первое сообщение дня — +10 XP.
- **👗 Гардероб**: в галерее у каждого образа кнопка «Надеть» — наряд
  мгновенно становится текущим для генераций.
- **😊 Панель эмоций**: тап по смайлику эмоции на аватаре открывает выбор
  из 23 настроений — можно вручную переключить картинку Лилит.
- **📤 Пригласить друга**: кнопка «Поделиться Лилит» (Telegram share).
- **📳 Хаптика**: лёгкая вибрация при нажатиях в Mini App.
- **📸 Фото меняется гарантированно**: даже если эмоция не определилась —
  Лилит выбирает случайное «живое» настроение (флирт/игривость/нежность).
- **🖼 10 новых сексуальных образов** в галерее: красный шёлк с перчатками,
  белое бельё на каблуках, чёрное кружево на стуле, розовый корсет,
  синее кружево на кровати, латекс, школьница в чулках, зелёный шёлк в ванной,
  красный бабидол, белый корсет у окна.

## 🚀 v2.0 — что нового

- **🔥 Ежедневный стрик** (как в топовых Mini App): серия дней общения с Лилит.
  За каждый день подряд — бонус XP (до +7). Круглые даты (3, 7, 14, 30, 60, 100 дней)
  Лилит отмечает поздравлениями. Рекорд и серия — в `/profile` и Mini App.
- **🏆 Достижения**: «Первое слово», «50 сообщений», «500 сообщений»,
  «3 дня подряд», «Неделя подряд», «Месяц подряд», уровни отношений —
  выдаются автоматически и видны в Mini App (вкладка «Ещё»).
- **🎭 Сцены** в Mini App: 6 готовых сценариев («Вечер при свечах», «Госпожа и слуга»,
  «Страстная ночь», «Нежность», «Ревность», «Сказка на ночь») — один тап,
  и Лилит начинает игру.
- **🖼 Галерея «Образы Лилит»**: 50+ встроенных сексуальных образов +
  твои сгенерированные фото — в одной вкладке.
- **📸 Фото меняется при КАЖДОМ ответе**: детектор эмоций v2 понимает эмодзи
  (😈🔥🥰😭😡…), интонации («!!», «?»), обращения («котик», «госпожа») —
  и выбирает новую эмоцию/картинку почти для каждого сообщения.
- **💜 «О нас»**: статистика отношений — уровень, серия дней, дней вместе,
  сообщений, XP.
